define [
    ...
    "hbs!templates/modules/flightStatsResult/fromToTitle"
], (Marionette, BoxModel, simpleComparison, FromToTitleTpl) ->
    ...
    filterConfigAirport =
        ...
        param: 
            ...
            filterItems: [
                { title: "loc_DepartureAirport", field: 'airportDepartureName'} 
                { title: "loc_ArrivalAirport", field: 'airportArrivalName'}
            ]
            filterField:'marketingCompanyName'
        ...
        componentItems: [
            {controlType: "filterListButton", controlModel: new Backbone.Model
                ...
                items: new Backbone.Collection [ 
                    { controlType: "filterButtonPopup", popup: popupSettings, filterConfig: filterConfigCompany }
                    { controlType: "filterButtonPopup", popup: popupSettings, filterConfig: filterConfigAirport }
                ]
            }

            {controlType: "simpleTplControl", controlModel: new Backbone.Model
                tpl: FromToTitleTpl
            ...
            {controlType: "tableControl", controlModel: new Backbone.Model(
                ...
                headers     : [undefined, "loc_Departure",  "loc_Arrival", "loc_Flight", "loc_Status"]
                headerHeight: 25
            ...
            {controlType: "infoControl", controlModel: infoStateModel}
